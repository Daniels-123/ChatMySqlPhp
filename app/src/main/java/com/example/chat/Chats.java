...
import com.example.chat.usersession.UserSession;
...
public class Chats extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userSession = new UserSession(Chats.this);
        HashMap<String, String> user = userSession.getUserDetail();
        usuario = (Usuario) getIntent().getExtras().getSerializable("usuario");
        nombreusuario = user.get(UserSession.NAME);
        getSupportActionBar().setTitle(usuario.toString());


        Toast.makeText(this, "el usuario es "+ nombreusuario, Toast.LENGTH_SHORT).show();
